...
class QliksenseData():
    ...
    def qlik_connct(self):
        try:
            ...
            #      }
            #     }
            print("Printing session", r)
            login_data =  { "PingUserName": "testuser1",
                          "PingUserDirectory": None,
                          "PingUserAccess":
            ...
            response = r.post("http://localhost:4500/user/login", data = login_data)
            print(response.json())

            response = r.get("http://localhost:4500/QlikSense/")
    ...
    def filter_by_dimension(self):
        ...
        try:
            ...
            json_data = {
                     ...
                     [ 'X-Qlik-Session=21d794a5-f179-4836-93f9-fe33d9309a24; Path=/; HttpOnly; Secure' ] 
                } 
                }
                         
            response = request.post("http://localhost:4500/QlikSenseMeasures/getFielddValue", json=json_data)
            #print(response.json())
            data = response.json()
        except Exception as e:
    ...
    def get_filter_value(self):
        ...
        try:
            ...
            response = requests.post("http://localhost:4500/QlikSenseMeasures/getFilterValue", json=json_data)
            #print(response.json())
            data = response.json()
        except Exception as e:
